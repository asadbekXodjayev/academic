...
export const PROJECTS: Project[] = [
  ...
  {
    id: 'corvette',
    title: 'Corvette — 3D Storytelling',
    descKey: 'work.projects.corvette',
    tech: ['Three.js', 'GSAP', 'Lenis', 'WebGL', 'GLB'],
    url: 'https://corvette.xodjayev.uz/',
  },
  {
    id: 'flowers',
    title: 'Vesna — Florist Store',
    descKey: 'work.projects.flowers',
    tech: ['Next.js', 'TypeScript', 'next-intl', 'TanStack Query', 'OpenAI'],
    url: 'https://flowers.xodjayev.uz/ru',
  },
  {
    id: 'shajara',
    title: 'Shajara — Family Tree',
    descKey: 'work.projects.shajara',
    tech: ['React', 'Vite', 'TypeScript', 'Node', 'SVG'],
    url: 'https://fam.xodjayev.uz/',
  },
  {
    id: 'graphforge',
    title: 'GraphForge — Diagram Editor',
    descKey: 'work.projects.graphforge',
    tech: ['Next.js', 'NestJS', 'Yjs', 'ELK', 'd3-force'],
    url: 'https://graph.xodjayev.uz/editor',
  },
  {
    id: 'cargolink',
